...
public class LightweightParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LightweightGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRegistrationAccess().getGroup_11(), "rule__Registration__Group_11__0");
			builder.put(grammarAccess.getCredentialAccess().getGroup(), "rule__Credential__Group__0");
			builder.put(grammarAccess.getCredentialAccess().getGroup_14(), "rule__Credential__Group_14__0");
			...
			builder.put(grammarAccess.getRecoveryAccess().getGroup_9(), "rule__Recovery__Group_9__0");
			...
			builder.put(grammarAccess.getResetAccess().getGroup_8(), "rule__Reset__Group_8__0");
			...
			builder.put(grammarAccess.getPossessionAccess().getTypeAssignment_0(), "rule__Possession__TypeAssignment_0");
			builder.put(grammarAccess.getPossessionAccess().getNameAssignment_5(), "rule__Possession__NameAssignment_5");
			builder.put(grammarAccess.getPossessionAccess().getValueAssignment_9(), "rule__Possession__ValueAssignment_9");
			builder.put(grammarAccess.getKnowledgeAccess().getTypeAssignment_0(), "rule__Knowledge__TypeAssignment_0");
			builder.put(grammarAccess.getKnowledgeAccess().getNameAssignment_5(), "rule__Knowledge__NameAssignment_5");
			builder.put(grammarAccess.getKnowledgeAccess().getValueAssignment_9(), "rule__Knowledge__ValueAssignment_9");
			builder.put(grammarAccess.getKnowledgeAccess().getLimitedAttemptsAssignment_13(), "rule__Knowledge__LimitedAttemptsAssignment_13");
			builder.put(grammarAccess.getKnowledgeAccess().getAutofilledAssignment_17(), "rule__Knowledge__AutofilledAssignment_17");
			builder.put(grammarAccess.getBiometricsAccess().getTypeAssignment_0(), "rule__Biometrics__TypeAssignment_0");
			builder.put(grammarAccess.getBiometricsAccess().getNameAssignment_5(), "rule__Biometrics__NameAssignment_5");
			builder.put(grammarAccess.getBiometricsAccess().getValueAssignment_9(), "rule__Biometrics__ValueAssignment_9");
			builder.put(grammarAccess.getRegistrationAccess().getTypeAssignment_0(), "rule__Registration__TypeAssignment_0");
			builder.put(grammarAccess.getRegistrationAccess().getNameAssignment_5(), "rule__Registration__NameAssignment_5");
			builder.put(grammarAccess.getRegistrationAccess().getCredentialsAssignment_10(), "rule__Registration__CredentialsAssignment_10");
			builder.put(grammarAccess.getRegistrationAccess().getCredentialsAssignment_11_1(), "rule__Registration__CredentialsAssignment_11_1");
			builder.put(grammarAccess.getCredentialAccess().getNameAssignment_4(), "rule__Credential__NameAssignment_4");
			builder.put(grammarAccess.getCredentialAccess().getProviderAssignment_8(), "rule__Credential__ProviderAssignment_8");
			builder.put(grammarAccess.getCredentialAccess().getTypeAssignment_12(), "rule__Credential__TypeAssignment_12");
			builder.put(grammarAccess.getCredentialAccess().getVerifmethodAssignment_14_2(), "rule__Credential__VerifmethodAssignment_14_2");
			...
			builder.put(grammarAccess.getRecoveryAccess().getProtocolAssignment_9_2(), "rule__Recovery__ProtocolAssignment_9_2");
			...
			builder.put(grammarAccess.getResetAccess().getAuthenticatorAssignment_8_2(), "rule__Reset__AuthenticatorAssignment_8_2");
			builder.put(grammarAccess.getResetAccess().getAuthMethodsAssignment_11(), "rule__Reset__AuthMethodsAssignment_11");
			builder.put(grammarAccess.getResetAccess().getAuthMethodsAssignment_12_1(), "rule__Reset__AuthMethodsAssignment_12_1");
		}
	}
