...
public class LightweightParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LightweightGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLoginAccess().getGroup_16(), "rule__Login__Group_16__0");
			...
			builder.put(grammarAccess.getResetAccess().getGroup_13(), "rule__Reset__Group_13__0");
			...
			builder.put(grammarAccess.getLoginAccess().getAuthMethodsAssignment_15(), "rule__Login__AuthMethodsAssignment_15");
			builder.put(grammarAccess.getLoginAccess().getAuthMethodsAssignment_16_1(), "rule__Login__AuthMethodsAssignment_16_1");
			...
			builder.put(grammarAccess.getResetAccess().getAuthMethodsAssignment_12(), "rule__Reset__AuthMethodsAssignment_12");
			builder.put(grammarAccess.getResetAccess().getAuthMethodsAssignment_13_1(), "rule__Reset__AuthMethodsAssignment_13_1");
		}
	}
