...
public class LightweightGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MFAElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cTypeMFAKeyword_0_0 = (Keyword)cTypeAssignment_0.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//'MFA'
		public Keyword getTypeMFAKeyword_0_0() { return cTypeMFAKeyword_0_0; }
	...
	public class PossessionElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cPossessionAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cTypeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final Keyword cTypePossessionKeyword_1_0 = (Keyword)cTypeAssignment_1.eContents().get(0);
		...
		private final RuleCall cValuePVALUEEnumRuleCall_10_0 = (RuleCall)cValueAssignment_10.eContents().get(0);
		...
		//{Possession} type='Possession' ':' "{" 'name' ":" name=EString "," 'value' ":" value=PVALUE "}"
		public Group getGroup() { return cGroup; }
		
		//{Possession}
		public Action getPossessionAction_0() { return cPossessionAction_0; }
		
		//type='Possession'
		public Assignment getTypeAssignment_1() { return cTypeAssignment_1; }
		
		//'Possession'
		public Keyword getTypePossessionKeyword_1_0() { return cTypePossessionKeyword_1_0; }
		...
		//PVALUE
		public RuleCall getValuePVALUEEnumRuleCall_10_0() { return cValuePVALUEEnumRuleCall_10_0; }
	...
	public class KnowledgeElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cKnowledgeAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cTypeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final Keyword cTypeKnowledgeKeyword_1_0 = (Keyword)cTypeAssignment_1.eContents().get(0);
		private final Keyword cColonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cNameKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Keyword cColonKeyword_5 = (Keyword)cGroup.eContents().get(5);
		...
		private final Keyword cColonKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Assignment cValueAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cValueKVALUEEnumRuleCall_10_0 = (RuleCall)cValueAssignment_10.eContents().get(0);
		...
		//{Knowledge}
		public Action getKnowledgeAction_0() { return cKnowledgeAction_0; }
		
		//type='Knowledge'
		public Assignment getTypeAssignment_1() { return cTypeAssignment_1; }
		
		//'Knowledge'
		public Keyword getTypeKnowledgeKeyword_1_0() { return cTypeKnowledgeKeyword_1_0; }
		...
		//KVALUE
		public RuleCall getValueKVALUEEnumRuleCall_10_0() { return cValueKVALUEEnumRuleCall_10_0; }
		
		//","
		public Keyword getCommaKeyword_11() { return cCommaKeyword_11; }
		
		//"limitedAttempts"
		public Keyword getLimitedAttemptsKeyword_12() { return cLimitedAttemptsKeyword_12; }
		...
		//'autofillable'
		public Keyword getAutofillableKeyword_16() { return cAutofillableKeyword_16; }
	...
	public class BiometricsElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cBiometricsAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cTypeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final Keyword cTypeBiometricsKeyword_1_0 = (Keyword)cTypeAssignment_1.eContents().get(0);
		private final Keyword cColonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cNameKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Keyword cColonKeyword_5 = (Keyword)cGroup.eContents().get(5);
		...
		private final Keyword cColonKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Assignment cValueAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cValueBVALUEEnumRuleCall_10_0 = (RuleCall)cValueAssignment_10.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_11 = (Keyword)cGroup.eContents().get(11);
		
		//Biometrics:
		//	{Biometrics} type='Biometrics' ':'
		//	"{"
		//	'name' ":" name=EString ","
		//	'value' ":" value=BVALUE
		//	"}";
		...
		//{Biometrics} type='Biometrics' ':' "{" 'name' ":" name=EString "," 'value' ":" value=BVALUE "}"
		public Group getGroup() { return cGroup; }
		
		//{Biometrics}
		public Action getBiometricsAction_0() { return cBiometricsAction_0; }
		
		//type='Biometrics'
		public Assignment getTypeAssignment_1() { return cTypeAssignment_1; }
		
		//'Biometrics'
		public Keyword getTypeBiometricsKeyword_1_0() { return cTypeBiometricsKeyword_1_0; }
		...
		//BVALUE
		public RuleCall getValueBVALUEEnumRuleCall_10_0() { return cValueBVALUEEnumRuleCall_10_0; }
	...
	public class RegistrationElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cRegistrationAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cTypeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final Keyword cTypeRegistrationKeyword_1_0 = (Keyword)cTypeAssignment_1.eContents().get(0);
		private final Keyword cColonKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cNameKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Keyword cColonKeyword_5 = (Keyword)cGroup.eContents().get(5);
		...
		private final RuleCall cNameEStringParserRuleCall_6_0 = (RuleCall)cNameAssignment_6.eContents().get(0);
		private final Keyword cCommaKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Keyword cAttributesKeyword_8 = (Keyword)cGroup.eContents().get(8);
		private final Keyword cColonKeyword_9 = (Keyword)cGroup.eContents().get(9);
		...
		private final RuleCall cAttributesAttributeParserRuleCall_12_1_0 = (RuleCall)cAttributesAssignment_12_1.eContents().get(0);
		...
		//{Registration} type='Registration' ":" '{' 'name' ":" name=EString "," 'attributes' ":" '[' attributes+=Attribute (","
		//attributes+=Attribute)* ']' '}'
		public Group getGroup() { return cGroup; }
		
		//{Registration}
		public Action getRegistrationAction_0() { return cRegistrationAction_0; }
		
		//type='Registration'
		public Assignment getTypeAssignment_1() { return cTypeAssignment_1; }
		
		//'Registration'
		public Keyword getTypeRegistrationKeyword_1_0() { return cTypeRegistrationKeyword_1_0; }
		...
		//'attributes'
		public Keyword getAttributesKeyword_8() { return cAttributesKeyword_8; }
		...
		//Attribute
		public RuleCall getAttributesAttributeParserRuleCall_12_1_0() { return cAttributesAttributeParserRuleCall_12_1_0; }
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl1.Lightweight.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//{Attribute} '{' 'name' ":" name=EString "," 'provider' ":" provider=PROVIDER "," 'type' ":" type=CredTYPE ","
	...
	public class RecoveryElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cProtocolAssignment_13_2 = (Assignment)cGroup_13.eContents().get(2);
		private final RuleCall cProtocolProtocolEnumRuleCall_13_2_0 = (RuleCall)cProtocolAssignment_13_2.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_14 = (Keyword)cGroup.eContents().get(14);
		...
		//'protocol'
		public Keyword getProtocolKeyword_13_0() { return cProtocolKeyword_13_0; }
		
		//":"
		public Keyword getColonKeyword_13_1() { return cColonKeyword_13_1; }
		
		//protocol=Protocol
		public Assignment getProtocolAssignment_13_2() { return cProtocolAssignment_13_2; }
		
		//Protocol
		public RuleCall getProtocolProtocolEnumRuleCall_13_2_0() { return cProtocolProtocolEnumRuleCall_13_2_0; }
